...
def test_bidding_demand_within_community_supply_external():
    ...
    orderbook = extend_orderbook(products, -500, 100, bid_id="building_demand")
    orderbook = extend_orderbook(products, 500, 130, orderbook, bid_id="external_supply")
...
def test_bidding_supply_within_community_demand_external():
    ...
    orderbook = extend_orderbook(products, -500, 70, bid_id="external_demand")
    orderbook = extend_orderbook(products, 500, 90, orderbook, bid_id="building_supply")
...
def test_sorting_with_building_priority():
    ...
    orderbook = extend_orderbook(products, 500, 130, bid_id="external_supply")
    orderbook = extend_orderbook(products, -400, 68, orderbook, bid_id="external_demand")
    orderbook = extend_orderbook(products, -0.2, 100, orderbook, bid_id="building_demand")
    orderbook = extend_orderbook(products, 0.3, 90, orderbook, bid_id="building_supply")
    ...
    assert accepted[0]["bid_id"] == "bid_building_demand"
    assert accepted[1]["bid_id"] == "bid_external_demand"
    assert accepted[2]["bid_id"] == "bid_building_supply"
    assert accepted[3]["bid_id"] == "bid_building_supply"
