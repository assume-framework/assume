...
def test_complex_clearing():
    ...
    order: Order = {
        ...
        "bid_id": "B1",
        "volume": 0,
        "price": {product[0]: 32 for product in products},
        "min_power": 200,
        "max_power": 1000,
        "ramp_up": 200,
        "ramp_down": 200,
        "start_up_cost": 325000,
        "shut_down_cost": 28500,
        "initial_output": 1000,
        "initial_status": 1,
        "bid_type": "MPB",
    }
    ...
    order: Order = {
        ...
        "bid_id": "B2",
        "volume": 0,
        "price": {product[0]: 36 for product in products},
        "min_power": 200,
        "max_power": 1000,
        "ramp_up": 200,
        "ramp_down": 200,
        "start_up_cost": 142500,
        "shut_down_cost": 18500,
        "initial_output": 200,
        "initial_status": 1,
        "bid_type": "MPB",
    }
    orderbook.append(order)
    orderbook = extend_orderbook(products, -1000, 100, orderbook, "SB")
    orderbook = extend_orderbook(products, -300, 100, orderbook, "SB")

    mr = UCClearingRole(market_config)
    mr.validate_orderbook(orderbook, products)
