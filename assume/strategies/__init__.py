...
deprecated_bidding_strategies: dict[str, type[BaseStrategy | UnitOperatorStrategy]] = {
    ...
    "pos_crm_dsm": DsmCapacityHeuristicBalancingStrategy,
    "neg_crm_dsm": DsmCapacityHeuristicBalancingStrategy,
...
bidding_strategies: dict[str, type[BaseStrategy | UnitOperatorStrategy]] = {
    ...
    "industry_capacity_heuristic_balancing_pos": DsmCapacityHeuristicBalancingStrategy,
    "household_capacity_heuristic_balancing_neg": DsmCapacityHeuristicBalancingStrategy,
