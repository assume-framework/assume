...
class StandardEOMPowerplantStrategy(BaseStrategy):
    """
...
class StandardPosCRMPowerplantStrategy(BaseStrategy):
    """
...
class StandardNegCRMPowerplantStrategy(BaseStrategy):
    """
