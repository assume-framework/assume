...
def add_agent_to_world(
    ...
    """
    strategies = {m: "powerplant_energy_heuristic_flexable" for m in list(world.markets.keys())}
    storage_strategies = {m: "storage_energy_heuristic_flexable" for m in list(world.markets.keys())}
