            ...
            if self.technology == "hydrogen_plant":
                ...
                if self.has_raw_mill and not (
                    ...
                    return (
                        ...
                        + m.load_shift_pos[t]
                        - m.load_shift_neg[t]
                        == self.model.dsm_blocks["raw_material_mill"].power_in[t]
                    )
                if self.has_cement_mill and not (
                    ...
                    return (
                        ...
                        + m.load_shift_pos[t]
                        - m.load_shift_neg[t]
                        == self.model.dsm_blocks["cement_mill"].power_in[t]
                    )
                if (
                    self.has_clinker_system
                    ...
                    return (
                        ...
                        + m.load_shift_pos[t]
                        - m.load_shift_neg[t]
                        == self.model.dsm_blocks["clinker_system"].power_in[t]
                        + self.model.dsm_blocks["cement_mill"].power_in[t]
                    )
                if (
                    self.has_raw_mill
                    ...
                    return (
                        ...
                        == self.model.dsm_blocks["clinker_system"].power_in[t]
                        + self.model.dsm_blocks["cement_mill"].power_in[t]
                        + self.model.dsm_blocks["ccs_system"].power_in[t]
                    )
                if (
                    self.has_clinker_system
                ...
                if (
                    ...
                    and self.has_electrolyser
                    and self.has_ccs_system
                    and not (self.has_raw_mill or self.has_hydrogen_buffer_storage)
                ):
                    return (
                        m.total_power_input[t]
                        + m.load_shift_pos[t]
