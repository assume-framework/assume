...
class WriteOutput(Role):
    ...
    def handle_output_message(self, content: dict, meta: MetaDict):
        ...
        if content_type in [
            ...
            # these need to be converted to df individually, include market_id
    ...
    def convert_flows(
        self, data: dict[tuple[datetime, str], float], market_id: str = None
    ):
        """
        ...
        Args:
            ...
            market_id (str, optional): The market identifier to add as a column. Defaults to None.
        """
        ...
        # Add market column if market_id is provided
        df["market"] = market_id
        ...
        for table, data_list in self.write_buffers.items():
            ...
            with self.locks[table]:
                ...
                match table:
                    ...
                    case "grid_flows":
                        dfs = []
                        for data, market_id in data_list:
                            df = self.convert_flows(data, market_id)
                            dfs.append(df)
