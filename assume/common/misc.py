...
def make_market_config(
    ...
    market_config = MarketConfig(
        ...
        maximum_gradient=market_params["max_gradient"],
        volume_unit=market_params["volume_unit"],
        volume_tick=market_params["volume_tick"],
        maximum_volume=market_params["maximum_volume"],
        price_tick=market_params["price_tick"],
