...
def is_demand_from_provider_needed(demand_order, supply_order) -> bool:
    return "building" in demand_order["bid_id"] and "building" not in supply_order["bid_id"]


def is_supply_from_provider_needed(demand_order, supply_order) -> bool:
    return "building" not in demand_order["bid_id"] and "building" in supply_order["bid_id"]
