...
def market_clearing_opt(
    ...
    Args:
        ...
        solver (str): The solver that is used, defaults to the HiGHS solver
        solver_options (dict): Any additional options passed to the solver
        ...
        func_objective: The function that is executed to add the objective to the model, defaults to :meth:`market_clearing_opt_objective`
