...
powerplant_units_data = {
    ...
    "bidding_EOM": ["naive_eom", "naive_eom", "naive_eom", "pp_learning"],
    "bidding_Redispatch": ["naive_redispatch", "naive_redispatch", "naive_redispatch", "naive_redispatch"],
    "fuel_type": ["renewable", "oil", "natural gas", "lignite"],
    "max_power": [15000.0, 1000.0, 2000.0, 2000.0],
    "min_power": [0, 0, 0, 0],
...
german_demand_data = pd.read_csv(f"{input_path}/{scenario}/german_demand_df.csv", index_col='datetime')
