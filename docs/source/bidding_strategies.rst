...
powerplant_energy_learning_redispatch  redispatch        An extension of the `EnergyLearningSingleBidStrategy` for Power Plants, adapted for participation in a Redispatch Market.
                                                         This strategy builds upon the single-bid approach used in energy-only markets, where the agent submits a single bid for the unit's maximum power.
                                                         The bid placed on the redispatch market has the same price as on the previous EOM. Further information submitted to the redispatch market is
                                                         current power, minimum power and maximum power. The reward calculation takes into account profits from both the EOM and redispatch market.
===================================== ================== =============================================================
