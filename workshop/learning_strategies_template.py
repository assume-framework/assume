...
class RLStrategy(LearningStrategy):
    ...
    def calculate_bids(
        ...
        **kwargs,
        ...
        # TODO bid_price_inflex =
        # ---------------------------

        # ---------------------------
        # 3.1 formulate the bids for Pmax - Pmin
        # Pmax - Pmin, the flexible capacity, which can be used in a more "risky" manner
        # bid_quantity_flex = ?
        # bid_price_flex = ?
    ...
    def get_actions(self, next_observation):
        ...
        if self.learning_mode:
            ...
            if self.collect_initial_experience_mode:
                ...
                # add noise to base bid to force exploration
    ...
    def create_observation(
        ...
        # =============================================================================
        # Observations are
        # - residual load forecast [0:foresight-1]
        # - price forecast [0:foresight-1]
        # - total capacity in t-1 [1]
        # - marginal cost [1]
        ...
        # TODO scaling_factor_res_load = #TODO

        # price forecast
        # TODO scaling_factor_price = #TODO

        # total capacity
        # TODO scaling_factor_total_capacity = #TODO

        # marginal cost
        # TODO scaling_factor_marginal_cost = #TODO
